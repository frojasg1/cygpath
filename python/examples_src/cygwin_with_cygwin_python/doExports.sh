...
CYGPATH_LIB_PATH="$( toAbsoluteUnixFileName "$LIB_SCR_PATH/cygpath_lib" )"
CYGPATH_LIB_IMPL_PATH="$( toAbsoluteUnixFileName "$LIB_SCR_PATH/cygpath_lib/impl/unix_like" )"
SYS_PATH_WRAPPER_PATH="$( toAbsoluteUnixFileName "$LIB_SCR_PATH/facade/cygwin_guestlike" )"
